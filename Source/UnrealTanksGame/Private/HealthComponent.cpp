...
void UHealthComponent::BeginPlay()
{
	...
	UnrealTanksGameMode = Cast<AUnrealTanksGameMode>(UGameplayStatics::GetGameMode(this));
}
	...
	AController* Instigator, AActor* DamageCauser)
{
	...
	Health -= Damage;
	if(Health <= 0.f && UnrealTanksGameMode)
	{
		UnrealTanksGameMode->KillActor(DamagedActor);
	}
}
